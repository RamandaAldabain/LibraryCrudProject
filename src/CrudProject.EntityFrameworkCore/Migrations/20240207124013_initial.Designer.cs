...
namespace CrudProject.Migrations
{
    ...
    [Migration("20240207124013_initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CrudProject.Models.Author", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CrudProject.Models.Book", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("CrudProject.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("CrudProject.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("CrudProject.Models.Book", b =>
                {
                    b.HasOne("CrudProject.Models.Author", "Author")
                        .WithMany("Books")
