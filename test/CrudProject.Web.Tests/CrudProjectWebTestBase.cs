...
{
    public abstract class CrudProjectWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static CrudProjectWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(CrudProjectWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<CrudProjectDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<CrudProjectDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<CrudProjectDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<CrudProjectDbContext, Task<T>> func)
        {
            T result;
